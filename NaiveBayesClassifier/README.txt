Corpus for Homework 2, USC CSCI 544, Spring 2017

Adapted from the Deceptive Opinion Spam Corpus v1.4


This adaptation contains the full text of hotel reviews from the original corpus, together with their truthful/deceptive and positive/negative labels. It does not retain the original directory structure and does not preserve an indication of the hotel names. It adds unique identifiers to the reviews. The adaptation was created by Ron Artstein, artstein@ict.usc.edu , for use in the course CSCI 544 Applied Natural Language Processing at the University of Southern California.
